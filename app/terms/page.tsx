    ...
    <MainLayout>
      ...
      >
        <VStack>
          ...
          <VStack px={5} gap={2} alignItems="start">
            <Heading as="h2" fontSize="md">
              1. Acceptance of Terms
            </Heading>
            <Text>
              By accessing Sportshub, you agree to comply with these Terms of
            ...
            <Text>
              You agree to use Sportshub responsibly and refrain from:
            </Text>
            <Box pl={5}>
            ...
            <Text>
              All content on Sportshub (text, images, logos, etc.) is owned by
              us or licensed to us. You may not copy, distribute, or modify our
            ...
            <Text>
              ...
              Sportshub. All sports data and results are provided
              &quot;as-is&quot; without warranties of accuracy.
            </Text>
